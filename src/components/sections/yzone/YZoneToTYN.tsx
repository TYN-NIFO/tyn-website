...
const accelerators = [
  { logo: yzoneLogo, alt: 'yZone', subtitle: 'AI Talent Accelerator', highlighted: true },
  { logo: nifoLogo, alt: 'NIFO', subtitle: 'Innovation Framework', highlighted: false },
  { logo: ynfinityLogo, alt: 'Ynfinity', subtitle: 'Continuous Learning', highlighted: false },
];
      ...
      <div className="container-main relative z-10">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-primary-foreground mb-4">
            How yZone connects to TYN
          </h2>
          <p className="text-lg text-primary-foreground/60 leading-relaxed">
            yZone is a feeder into TYN's broader transformation ecosystem. Successful ideas,
            teams, and learnings flow directly into enterprise-grade programs.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-6">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto border-2 border-primary-foreground/15 rounded-2xl p-8 bg-primary-foreground/5 backdrop-blur-sm">
            ...
            {/* Triangle layout: highlighted on top, two below */}
