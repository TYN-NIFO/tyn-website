...
export const AiCoeHero = () => {
  ...
  const scrollToContent = () => {
    document.getElementById('why-coe-fails')?.scrollIntoView({ behavior: 'smooth' });
  };
      ...
      <div className="relative z-10 container-main py-24 md:py-32">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-primary-foreground mb-8 leading-[1.1] animate-fade-up delay-100">
            Build a sustainable execution for AI outcomes{' '}
            <span className="text-gradient">not just pilots</span>
          </h1>
          ...
          <p className="text-base md:text-lg text-primary-foreground/50 mb-10 animate-fade-up delay-300 leading-relaxed max-w-2xl">
            We bridge the chasm between raw AI capability and production-grade business value by institutionalizing governance, engineering rigour, and a{' '}
            <span className="text-accent font-semibold">"builders-first"</span> culture.
          </p>
